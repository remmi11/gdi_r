            ...
            invalid: [], getCaret: function () {
                try {
                    ...
                    if (f && -1 === navigator.appVersion.indexOf("MSIE 10")) q = f.createRange(), q.moveStart("character", a.is("input") ? -a.val().length : -a.text().length),
                        v = q.text.length; else if (c || "0" === c) v = c;
                    return v
                } catch (d) {
                }
            }, setCaret: function (q) {
                ...
                if (-1 === b.inArray(e, g.byPassKeys)) {
                    var d = c.getCaret(), f = c.val().length, n = d < f, h = c.getMasked(), k = h.length,
...
!function (e) {
    ...
    var i = function (e) {
            ...
            data: {}, init: function (e) {
                ...
                var r = n.config[i], l = M("caption", r) ? r.caption : "", o = M("width", r) ? r.width : "auto",
                    s = M("url", r) ? r.url : !1, d = M("key", r) ? r.key : null, c = s === !1 && a,
                    p = n.isDelete ? n.actions(!1, !0, c, s, d) : "", u = n.footer.repl("{actions}", p);
        ...
        U = {
            ...
            actionDelete: C,
            actionUpload: y
        }, j = {generic: T, html: E, image: F, text: k, video: $, audio: I, flash: D, object: P, other: S},
    ...
    H.prototype = {
        constructor: H, validate: function () {
            var e, i = this;
            ...
            var n = this, r = e.trim(t + ""), l = "." === r.slice(-1) ? "" : ".", o = e(i.responseText).text();
            ...
            var i = this, t = i.minFileCount > 1 ? i.filePlural : i.fileSingle,
                a = i.msgFilesTooLess.repl("{n}", i.minFileCount).repl("{files}", t), n = i.$errorContainer;
            ...
            i.getThumbs().each(function () {
                ...
                -1 !== r && (void 0 !== l ? (a[t] = l, n.attr({
                    ...
                    "data-fileindex": t
                }), t += 1) : n.attr({id: "uploaded-" + N(), "data-fileindex": "-1"}))
            }), i.filestack = a
        }, refresh: function (i) {
            ...
            if (!e && !i) return "";
            var r = this, l = a === !1 ? "" : ' data-url="' + a + '"', o = n === !1 ? "" : ' data-key="' + n + '"',
                s = r.getLayoutTemplate("actionDelete"), d = "", c = r.getLayoutTemplate("actions"),
                p = r.otherActionButtons.repl("{dataKey}", o), u = r.fileActionSettings,
            ...
            var r, l, s, d, c, p, u, f, v, h, m = this, g = m.getFileStack().length, w = new FormData,
                b = m.previewInitId + "-" + i, x = e("#" + b + ":not(.file-preview-initial)"),
                C = x.find(".kv-file-upload"), y = x.find(".kv-file-remove"), T = x.find(".file-upload-indicator"),
                E = m.fileActionSettings, F = m.filestack.length > 0 || !e.isEmptyObject(m.uploadExtraData),
                k = {id: b, index: i};
            ...
            var i, t, a, n, r, l, s, d, c = this, p = c.filestack, u = p.length,
                f = c.filestack.length > 0 || !e.isEmptyObject(c.uploadExtraData), v = {};
            c.formdata = new FormData, 0 !== u && f && !c.abort(v) && (i = c.fileActionSettings, t = function (t, a, n) {
                ...
                var t = e("#" + c.previewInitId + "-" + i + ":not(.file-preview-initial)"),
                    a = t.find(".kv-file-upload"), n = t.find(".kv-file-delete");
            ...
            if (this.showPreview) {
                var n = this, r = q.createObjectURL(i), l = e("#" + t), o = n.previewSettings.other,
                    s = n.renderFileFooter(i.name, o.width), d = n.getPreviewTemplate("other"),
                    c = t.slice(t.lastIndexOf("-") + 1), p = "";
            ...
            if (this.showPreview) {
                var n, r, l, o, s = this, d = s.parseFileType(e), c = s.slug(e.name), p = s.allowedPreviewTypes,
                    u = s.allowedPreviewMimeTypes, f = s.getPreviewTemplate(d),
                    v = M(d, s.previewSettings) ? s.previewSettings[d] : L[d], h = parseInt(s.wrapTextLength, 10),
                    m = s.wrapIndicator, g = p.indexOf(d) >= 0, w = R(u) || !R(u) && -1 !== u.indexOf(e.type),
                    b = s.renderFileFooter(c, v.width), x = "", C = t.slice(t.lastIndexOf("-") + 1);
            ...
            function t(e) {
                ...
                var m, g, w, b, x, C, y = v + e, T = p + "-" + y, E = i[e], F = a.slug(E.name), k = (E.size || 0) / 1e3,
                    $ = "", I = q.createObjectURL(E), D = 0, P = a.allowedFileTypes, S = R(P) ? "" : P.join(", "),
                    U = a.allowedFileExtensions, j = R(U) ? "" : U.join(", ");
            ...
            var a = this, n = a.$element, r = a.$preview, l = a.reader, o = a.$previewContainer, s = a.$previewStatus,
                d = a.msgLoading, c = a.msgProgress, p = a.previewInitId, u = i.length, f = a.fileTypeSettings,
                v = a.filestack.length, h = function (t, n, r, l) {
            ...
            var i = this, a = i.$element, n = i.getFileStack(), r = a.val() || n.length && n[0].name || "",
                l = i.slug(r), o = i.isUploadable ? n.length : e, s = t.count(i.id) + o,
            ...
            var r, l, o, s, d = a.$preview, c = arguments.length > 1,
                p = c ? i.originalEvent.dataTransfer.files : n.get(0).files, u = R(n.attr("multiple")), f = 0, v = 0,
                h = a.filestack.length, m = a.isUploadable, g = function (i, t, n, r) {
            ...
            if (l) a = e("<div>" + r.msgValidationError + "</div>").text(), n = '<span class="' + r.msgValidationErrorClass + '">' + r.msgValidationErrorIcon + a + "</span>"; else {
        ...
        if (n() || i(9)) {
            ...
            return a.shift(), this.each(function () {
                var i, n = e(this), r = n.data("fileinput"), l = "object" == typeof t && t,
