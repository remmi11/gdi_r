...
!function (a) {
    ...
    var b = function (b) {
        ...
        var c = this, d = {
            getValue: function () {
                var b = null, d = c.selector, e = "#" + d, f = 'input[name="' + d + '"]:checked',
                    g = 'input[name="' + d + '[]"]:checked', h = "";
                switch (!0) {
        ...
        var d = this, e = !1, f = new b(d.selector), g = function (b) {
            var c = a.trim(f.value).toLowerCase(), e = a.trim(d.value).toLowerCase(),
        ...
        var d = this, e = !1, f = new b(d.selector), g = (f.$field, f.$container, []), h = {
            all: function () {
                for (var a = !0, b = 0, c = g.length; c > b; b++) a = a && g[b].isValid();
                return a
            }, any: function () {
                for (var a = 0, b = g.length; b > a; a++) if (g[a].isValid()) return !0;
                return !1
            }, none: function () {
                for (var a = !0, b = 0, c = g.length; c > b; b++) a = a && !g[b].isValid();
                return a
            ...
            return e = h[d.match](), i[d.action](e), e
        };
        j(), this.validate = k, this.isValid = e
    }, e = function (a) {
        this.logics = a && a.logics || [];
        var b = this, c = [], e = function () {
            var a, e, f;
    ...
    var b, c, d = 1, e = a(".actions li.previous"), f = a(".actions li.next"), g = a(".actions .previous > a"),
        h = a(".actions .next > a"), i = a(".actions .numberText > label"), j = a("div.submit"),
        k = a(".stepBar .progress-bar"), l = k.find("label"), m = progressDefaultText = l.text(), n = function (a) {
            ...
            var a = (d - 1) / b * 100 + "%", c = k.find("label"), e = m.replace("{percent}", a);
            ...
            function b(b, c) {
                if (c.hasClass("page")) {
                    var d = c.attr("id"), e = a('li[data-page-fid="' + d + '"'), f = v(e.data("pageStep"));
                    switch (b) {
                        case"logic:show":
...
}(jQuery), $("body").formSteps("init"), function (a) {
    function b(b, c) {
        if (b.length) {
            c || (c = window);
            var d = !1, e = function () {
    ...
    jQuery.validator.addMethod("compareTo", function (c, d) {
        var e = !0, f = a(d), g = f.data("rule-compareto"), h = f.data("rule-compareto-method"),
            i = f.data("rule-compareto-diff"), j = f.data("rule-compareto-type"), k = f.val(), l = a(g).val();
    ...
    function a() {
        ...
        if (-1 !== a) {
            var b = window.location.href.slice(a + 1), c = deparam(b);
            $.each(c, function (a, b) {
                try {
    ...
    function b(a) {
        var b = $(a), c = b.attr("action"), d = -1 == c.indexOf("?") ? "?" : "&", e = c + d + "method=csrfToken";
        $.get(e, function (a) {
            try {
                a = $.parseJSON(a)
            } catch (c) {
    ...
    function c() {
        var a = /^https*:\/\/[^.]*\.*jquery\-*form\.com\//i, b = location.href.match(a), c = document.referrer.match(a),
            d = b && !c;
    ...
    function d() {
        var a = function () {
            var a = $(this), b = a.closest("div.form-group"), c = b.find("input.jf-has-box");
            c.each(function () {
                var b = $(this).attr("id") + "_box", c = $("#" + b);
                $(this).is(":checked") && c.show(), a.attr("id") + "_box" == b && c.focus()
            })
        };
        $(".jf-form").on({click: a, handleOptionBox: a}, ".jf-has-box"), $(".jf-option-box").blur(function () {
    ...
    function e() {
        var a = "%3Ca%20href%3D%22http%3A%2F%2Fwww.jqueryform.com%22%20target%3D%22_blank%22%20class%3D%22jf-copyright%22%20style%3D%22color%3A%20%23888888%3B%20display%3A%20inline-block%3B%20margin%3A%2016px%3B%22%3EPowered%20by%20jqueryform.com%3C%2Fa%3E",
            b = ".jf-", c = b + "form a" + b + "copyright";
        $(c).length ? $(c).prop("href", "http://www.jqueryform.com").text("Powered by jqueryform.com") : $(decodeURIComponent(a)).appendTo($(b + "form")), $(c).show()
    }
    ...
    function f(a) {
        var b = function (b) {
            ...
            c.closest("div.form-group").addClass("bg-info has-error" + (d ? " has-feedback" : "")), c.is(":visible") && d && !c.data("glyphicon") && ($('<span class="glyphicon glyphicon-warning-sign form-control-feedback" aria-hidden="true"></span>').insertAfter(c), c.data("glyphicon", !0), setTimeout(function () {
                ...
                var g = c.closest("div.form-group").find("span.glyphicon-warning-sign"),
                    h = {top: a.top + (b - g.height()) / 2 + 4, left: a.left + d + 10};
                g.offset(h)
        ...
        var d = function (a, b) {
            ...
            var a, b = $("#g-recaptcha").data("size"), c = function () {
                var a = function () {
                    (!b || grecaptcha) && $("#g-recaptcha-response").length && ($("#g-recaptcha-response").rules("add", {required: !0}), b && grecaptcha.execute(), clearInterval(c))
                }, c = setInterval(a, 800)
            }, d = function () {
                $("#g-recaptcha-response").length && ($("#g-recaptcha-response").valid(), a = !0)
            };
            return {
                init: c, checkRequired: function () {
                    a || setInterval(d, 800)
                }
            }
        }(), g = function (a, b) {
            ...
            if (b.length) {
                ...
                var e = function () {
                    if (parent) {
                        ...
                        a.length > 0 && $(window.parent.document).find("html, body").animate({scrollTop: a.offset().top}, 500)
                    }
                };
            ...
            a = {width: b.outerWidth(), height: b.outerHeight()};
            var d = function () {
                c.css(a).show(), b.prop("disabled", !0)
            }, e = function () {
                c.hide(), b.prop("disabled", !1)
            };
            return {showProgressBar: d, hideProgressBar: e}
        }, l = function (a) {
            ...
            var d = function () {
                var c = $(a).ajaxSubmit(), d = c.data("jqxhr");
                d.done(function (a) {
                    var c = !1;
                    try {
                        data = $.parseJSON(a)
                    } catch (d) {
                        c = !0, data = {validated: !1}
                    }
                    data && data.validated === !0 ? ($(".jf-form").hide(),
                        ...
                        $btn.hideProgressBar(), setTimeout(function () {
    ...
    function h() {
        $("input[type=file].form-control").each(function (a, b) {
            var c = {
                    ...
                    uploadAsync: !1
                }, d = $(b), e = "showPreview,showRemove,showUpload,showZoom".split(","),
                f = d.data("allowedfileextensions"), g = d.data("multiple"), h = d.data("browselabel"),
                i = parseInt(d.data("maxfilecount")), j = d.data("maxfilesize");
            ...
            for (var a = 0, k = e.length; k > a; a++) {
                var l = e[a], m = /(false|0|no)/i, n = m.test(String(d.data(l.toLowerCase())));
                n && (c[l] = !1)
            }
            d.fileinput(c)
        }), setTimeout(function () {
    ...
    var i = {};
    i.init = function (e) {
        c(), h(), g(".datepicker"), d(), f(e), b(e), a(), $(document).trigger("JF.ready", {formId: e}), $.setResponsiveToImages($(e).find("img"))
    ...
    function a(a, b) {
        for (var c, d = [], e = !1, f = !1, a = String(a).toLowerCase(), g = 0, h = b.length; h > g; g++) {
            ...
            if (i && String(c.value).toLowerCase() == a) e = !0; else {
    ...
    function b(b) {
        var c = d[b];
        if (c) {
            var e = c.options, b = "#" + b, f = "#" + c.dependOn;
            $(f).change(function () {
                var c = $(this).val(), d = a(c, e), f = [];
                $(b).empty();
                for (var g = 0, h = d.length; h > g; g++) {
                    var i = d[g], j = $.trim(i.value),
